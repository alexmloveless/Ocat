...
def test_main_basic_flow(mock_console, mock_prompt_session, mock_chat_session, mock_config_load):
...
def test_main_with_config_override(mock_config_load):
    ...
    with patch('ocat.cli.ChatSession'), \
         patch('ocat.cli.PromptSession') as mock_prompt_session, \
         patch('ocat.cli.Console'):
        ...
        mock_config_load.assert_called_once_with("custom.json")
